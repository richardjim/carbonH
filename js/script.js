...
window.addEventListener("scroll","click" ,() => {
  let facelist = document.querySelectorAll(".facelist");
  facelist.classList.toggle("active", window.scrollX > 0);
});
...
back.addEventListener("scroll","click" , () => {
  let facelist = document.querySelectorAll(".facelist");
  facelist.classList.toggle("active", window.scrollY < 0);
});

let forward = document.querySelector("#forward");
forward.addEventListener("scroll","click", () => {
  let facelist = document.querySelectorAll(".facelist");
  facelist.classList.toggle("active", window.scrollY > 0);
});
